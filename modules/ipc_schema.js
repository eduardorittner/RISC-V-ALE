...
export function validateWorkerMessage(msg) {
  ...
  switch (msg.type) {
    ...
    case "code_load":
      if (
        !msg.code ||
        (typeof msg.code !== "object" && !Array.isArray(msg.code))
      ) {
        return {
          success: false,
          error: "code_load requires code array/object",
        };
      }
      break;
    ...
    case "interrupt":
      if (typeof msg.state !== "number") {
        return {
          success: false,
          error: "interrupt message requires numeric state",
        };
      }
      break;
    ...
    case "sync":
      ...
      if (
        ...
        return {
          success: false,
          error:
            "sync message requires buffer, mmio_buffer, or stdout/stderr payload",
        };
      }
      break;
    ...
    case "debug_enable":
      if (typeof msg.enabled !== "boolean") {
        return {
          success: false,
          error: "debug_enable requires boolean enabled",
        };
      }
      break;
    ...
    case "debug_set_bp":
      if (typeof msg.addr !== "number" || typeof msg.active !== "boolean") {
        return {
          success: false,
          error: "debug_set_bp requires numeric addr and boolean active",
        };
      }
      break;
    ...
    case "debug_disasm":
      if (typeof msg.addr !== "number" || typeof msg.len !== "number") {
        return {
          success: false,
          error: `${msg.type} requires numeric addr and len`,
        };
      }
      break;
    ...
    case "debug_poke_reg":
      if (typeof msg.reg !== "number" || typeof msg.val !== "number") {
        return {
          success: false,
          error: "debug_poke_reg requires numeric reg and val",
        };
      }
      break;
    ...
    case "debug_poke_mem":
      if (typeof msg.addr !== "number" || typeof msg.val !== "number") {
        return {
          success: false,
          error: "debug_poke_mem requires numeric addr and val",
        };
      }
      break;
    ...
    case "status":
      if (!msg.status || typeof msg.status !== "object") {
        return {
          success: false,
          error: "status message requires status object payload",
        };
      }
      break;
