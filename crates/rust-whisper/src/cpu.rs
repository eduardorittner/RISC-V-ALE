        ...
        match opcode {
            ...
            0x33 => {
                ...
                let val = match (funct7, funct3) {
                    ...
                    (0x01, 1) => (((src1 as i64 * src2 as i64) >> 32) & 0xFFFFFFFF) as u32, // MULH
                    (0x01, 2) => (((src1 as i64 * src2 as u64 as i64) >> 32) & 0xFFFFFFFF) as u32, // MULHSU
